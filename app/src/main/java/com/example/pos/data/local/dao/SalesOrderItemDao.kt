...
interface SalesOrderItemDao {
    ...
    fun getItemsBySalesOrderId(salesOrderId: Long): Flow<List<SalesOrderItemEntity>>

    @Insert(onConflict = OnConflictStrategy.REPLACE)
    suspend fun insert(item: SalesOrderItemEntity): Long
    ...
    suspend fun deleteBySalesOrderId(salesOrderId: Long)
} 